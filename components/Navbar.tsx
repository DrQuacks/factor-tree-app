    ...
    <div className="relative w-full border-b border-gray-200" style={{ backgroundColor: '#FCF9F2' }}>
      ...
      <div className="sm:hidden">
                  ...
                  <div className="flex items-center justify-center py-1 px-4">
                    <div className="text-xl font-light tracking-wider text-center" style={{ color: '#4A6FA5', fontFamily: 'Georgia, serif' }}>
                      Prime Factor Trees
                    </div>
                  </div>
                  
                  {/* Bottom Line - Menu, Counter, Button */}
          ...
          <div className="flex items-center gap-2">
            <div className="text-xs text-slate-600 font-medium bg-slate-100 px-2 py-1 rounded-md">
              Incorrect: {incorrectMoves}
            </div>
            <button
              onClick={onFullyFactored}
